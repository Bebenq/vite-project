      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[15px] font-bold cursor-pointer flex ">
            Benny &nbsp;
            <span className="sm:block hidden">| &nbsp; App Dev</span>
          </p>
        </Link>
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          <img src={toggle ? close : menu} alt="menu" className="q-[28px] h-[28px] object-contain cursor-pointer" onClick={() => setToggle(!toggle)} />
