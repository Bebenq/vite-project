  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Medus Korlap",
          from_email: form.email,
          to_email: "meduskorlap@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Terimakasih sudah menghubungi ku. Develop akan membalas anda. x.");
  ...
  return (
    <div className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden`}>
      <motion.div variants={slideIn("left", "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        <p className={styles.sectionSubText}>Pesan</p>
